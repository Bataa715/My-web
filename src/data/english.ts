...
export const initialEnglishRule: Omit<GrammarRule, 'id' | 'createdAt'> = {
  ...
  category: "Tense",
  introduction: "Тогтмол давтагддаг үйлдэл, үнэн баримт, хуваарь, дүрэм журам, ерөнхий зан байдал, байнгын байдал зэргийг илэрхийлэхэд хэрэглэгддэг.",
  usage: [
    { condition: "Тогтмол давтагддаг, зуршил болсон үйлдэл", example: "I work every day." },
    { condition: "Байгалийн хууль, ерөнхий үнэн баримт", example: "The Earth revolves around the Sun." },
    { condition: "Хуваарийн дагуух үйл явдал", example: "The train leaves at 8 AM." }
  ],
  form: {
    regular: "Ихэнх үйл үгэнд **-s** залгана: `works`, `plays`, `reads`.\n\n`-s, -sh, -ch, -x, -o` төгсгөлтэй бол **-es** залгана: `goes`, `watches`, `fixes`.\n\nГийгүүлэгч + `y`-ээр төгссөн бол 'y' үсгийг 'i' болгож **-ies** залгана: `study` -> `studies`.",
  ...
  practice: [
    ...
    },
    {
      ...
      correctAnswer: "do",
      explanation: "“We” үед үйл үг “do” хэвээр байна, ямар нэгэн -s нэмэгдэхгүй."
    },
    {
      question: "What time ____ the train leave?",
      options: ["do", "is", "does"],
      correctAnswer: "does",
      explanation: "“The train” → “it” учраас “does” хэрэглэнэ. Үйл үг “leave” үндсэн хэлбэртэй байна."
    },
    {
      question: "They ____ go to the gym on weekends.",
      options: ["usually", "is", "are"],
      correctAnswer: "usually",
      explanation: "“Usually” бол Present Simple-д хэрэглэдэг давтамж илэрхийлэгч үг."
    },
    {
      question: "My friend and I ____ tennis every Saturday.",
      options: ["play", "plays", "are playing"],
      correctAnswer: "play",
      explanation: "“My friend and I” = “we” → “play” нь үндсэн хэлбэрээр байна."
    },
    {
      question: "Does she ____ coffee in the morning?",
      options: ["drinks", "drink", "is drinking"],
      correctAnswer: "drink",
      explanation: "“Does” байгаа учраас үйл үг “drink” үндсэн хэлбэрээр хэрэглэгдэнэ. “drinks” бол буруу."
    }
  ]
};
