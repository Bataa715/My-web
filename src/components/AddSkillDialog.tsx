        ...
        <Dialog open={open} onOpenChange={setOpen}>
            ...
            <DialogContent className="max-w-2xl">
                <DialogHeader>
                    ...
                    <DialogDescription>
                        Бүлгийн нэр, icon-г сонгоод AI ашиглан эсвэл гараар ур чадваруудаа нэмнэ үү.
                    </DialogDescription>
                </DialogHeader>
                <form onSubmit={handleSubmit} className="grid gap-6 py-4">
                    ...
                    <div className="space-y-2 rounded-lg border p-4">
                        <Label htmlFor="ai-search" className="flex items-center gap-2 font-semibold">
                        ...
                        {(isSearching || generatedSkills.length > 0) && (
                            <div className="pt-2">
                                {isSearching && <div className="text-sm text-muted-foreground flex items-center justify-center p-4"><Loader2 className="animate-spin mr-2"/> Ур чадвар хайж байна...</div>}
                                {generatedSkills.length > 0 && (
                                    <div className="flex flex-wrap gap-2">
                                        {generatedSkills.map(skill => (
                                            <Badge
                                                key={skill}
                                                variant={items.includes(skill) ? "default" : "secondary"}
