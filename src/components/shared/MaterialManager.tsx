...
export default function MaterialManager({
    ...
    useEffect(() => {
        ...
        const fetchMaterials = async () => {
            ...
            try {
                ...
                toast({ title: "Алдаа", description: "Материал татахад алдаа гарлаа.", variant: "destructive" });
            } finally {
                setLoading(false);
            }
        };
    ...
    const handleAddMaterial = async (newMaterial: Omit<ReadingMaterial, 'id' | 'createdAt'>) => {
        ...
        try {
            ...
            toast({ title: "Алдаа", description: "Материал нэмэхэд алдаа гарлаа.", variant: "destructive" });
        }
    };
    ...
    const handleDeleteMaterial = async (id: string) => {
        ...
        try {
            ...
            toast({ title: "Алдаа", description: "Материал устгахад алдаа гарлаа.", variant: "destructive" });
        }
    };
    ...
    return (
        <div className="space-y-8">
            ...
            <div className="text-center pt-8 flex flex-col items-center justify-center gap-4">
                ...
                <p className="mt-2 text-muted-foreground max-w-2xl">{pageDescription}</p>
            </div>
            {loading ? (
                ...
                <div className="pt-8 space-y-4">
                    {materials.length > 0 ? (
                        materials.map((material) => (
                            <Card key={material.id} className="relative group">
                                <CardHeader>
                                            ...
                                            <AlertDialog>
                                                ...
                                                <AlertDialogContent>
                                                    <AlertDialogHeader>
                                                        ...
                                                        <AlertDialogDescription>
                                                            Энэ үйлдлийг буцаах боломжгүй. "{material.title}" материал бүрмөсөн устгагдах болно.
                                                        </AlertDialogDescription>
                                                    </AlertDialogHeader>
                                                    <AlertDialogFooter>
                                                        <AlertDialogCancel>Цуцлах</AlertDialogCancel>
                                                        <AlertDialogAction onClick={() => handleDeleteMaterial(material.id!)}>Устгах</AlertDialogAction>
                                                    </AlertDialogFooter>
                                                </AlertDialogContent>
                                            </AlertDialog>
                                        )}
                                    ...
                                    {material.source && (
                                        <CardDescription>Эх сурвалж: {material.source}</CardDescription>
                                    )}
                                </CardHeader>
                        ...
                        <Card className="text-center p-8">
                            <CardContent>
                                <p className="text-muted-foreground">Одоогоор материал байхгүй байна.</p>
                            </CardContent>
                        </Card>
                    )}
                </div>
