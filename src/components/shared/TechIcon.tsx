...
const techIconMap: Record<string, { slug: string; color: string }> = {
    ...
    'power bi': { slug: 'power-bi', color: 'F2C811' },
    'powerbi': { slug: 'power-bi', color: 'F2C811' },
    'microsoft excel': { slug: 'microsoft-excel', color: '217346' },
    'excel': { slug: 'microsoft-excel', color: '217346' },
    'microsoft word': { slug: 'microsoft-word', color: '2B579A' },
    'word': { slug: 'microsoft-word', color: '2B579A' },
    'microsoft powerpoint': { slug: 'microsoft-powerpoint', color: 'B7472A' },
    'powerpoint': { slug: 'microsoft-powerpoint', color: 'B7472A' },
                ...
                <Tooltip>
                    <TooltipTrigger asChild>
                        <div className={cn(
                            ...
                            <span className="text-2xl leading-none">{languageFlags[techKey]}</span>
                        </div>
                    </TooltipTrigger>
                    <TooltipContent>
                        <p>{techName}</p>
    ...
    if (!iconUrl || imageError) {
        return (
             <TooltipProvider>
                <Tooltip>
                    <TooltipTrigger asChild>
                         <div className={cn("flex h-8 w-8 items-center justify-center rounded-full border border-neutral-700 bg-gradient-to-br from-neutral-800 to-neutral-900", className)}>
