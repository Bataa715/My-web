...
export function AddMaterialDialog({ children, onAddMaterial, dialogTitle, dialogDescription }: AddMaterialDialogProps) {
            ...
            <DialogContent className="sm:max-w-[625px]">
                ...
                <form onSubmit={handleSubmit} className="grid gap-4 py-4">
                    <div>
                        ...
                        <Input id="material-title" value={title} onChange={(e) => setTitle(e.target.value)} placeholder="Материалын гарчиг..." required />
                    </div>
                     <div>
