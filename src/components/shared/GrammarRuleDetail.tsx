        ...
        <CardHeader className="bg-muted/30">
          <div className="flex justify-between items-start">
            <div className="space-y-2">
              ...
              <CardDescription className="text-base prose dark:prose-invert max-w-none pt-2">
                {rule.introduction}
              </CardDescription>
            </div>
            {isEditMode && rule.id && (
        ...
        <CardContent className="p-6 space-y-8">
          ...
          <div id="form">
            <h3 className="text-xl font-bold mb-4">
              3. Үйл үгний хэлбэр (Form)
            </h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <Card>
                <CardHeader>
                  <CardTitle>Regular Verbs</CardTitle>
                </CardHeader>
          ...
          <div id="structure">
            <h3 className="text-xl font-bold mb-4">
              4. Өгүүлбэрийн бүтэц (Sentence Structure)
            </h3>
          ...
          <div id="time-expressions">
            <h3 className="text-xl font-bold mb-4">
              5. Цаг хугацааны илэрхийлэл (Time Expressions)
            </h3>
