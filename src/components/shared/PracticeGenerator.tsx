  ...
  return (
    <Card key={index} className="mb-4">
      ...
      <CardContent className="space-y-2">
        ...
        {isAnswered && (
          <div
            className={`mt-4 p-4 rounded-md flex items-start gap-3 ${selectedOption === mcq.correctAnswer ? 'bg-green-100 dark:bg-green-900/30 text-green-800 dark:text-green-300' : 'bg-red-100 dark:bg-red-900/30 text-red-800 dark:text-red-300'}`}
          >
            ...
            <div>
              <h4 className="font-bold">
                {selectedOption === mcq.correctAnswer ? 'Зөв!' : 'Буруу!'}
              </h4>
