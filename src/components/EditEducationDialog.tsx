...
const educationSchema = z.object({
  ...
  startDate: z.string().refine((val) => !isNaN(Date.parse(val)), { message: "Эхлэх огноо буруу байна." }),
  endDate: z.string().refine((val) => !isNaN(Date.parse(val)), { message: "Дуусах огноо буруу байна." }),
  score: z.string().optional(),
});


export function EditEducationDialog({ children, education }: EditEducationDialogProps) {
