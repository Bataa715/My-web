...
export default function LanguageCard({ language, onDelete }: LanguageCardProps) {
            ...
            <Link href={`/tools/programming/${language.id}`}>
                ...
                >
                    <div>
                        ...
                        <h3 className="text-white text-xl font-bold text-center mb-2">{language.name}</h3>
                    </div>
                    <div className="mt-4">
                        ...
                        <p className="text-gray-400 text-xs mt-2 text-right">{language.progress}% completed</p>
                    </div>
                </div>
            </Link>
             {isEditMode && (
                <AlertDialog>
                    ...
                    <AlertDialogContent>
                        <AlertDialogHeader>
                            ...
                            <AlertDialogDescription>"{language.name}" хэлийг устгах гэж байна. Энэ үйлдэл буцаагдахгүй.</AlertDialogDescription>
                        </AlertDialogHeader>
                        <AlertDialogFooter>
                            <AlertDialogCancel>Цуцлах</AlertDialogCancel>
                            <AlertDialogAction onClick={() => onDelete(language.id!, language.name)}>Устгах</AlertDialogAction>
                        </AlertDialogFooter>
                    </AlertDialogContent>
                </AlertDialog>
            )}
