            ...
            <CardContent className="space-y-4 relative z-10">
              ...
              <Card className="bg-emerald-500/5 border-emerald-500/20">
                <CardContent className="p-4">
                  ...
                  <p className="text-sm text-muted-foreground mb-3">
                    5 аргын орох/гарах цэгүүдийг харьцуулна
                    <br />
                    Санал нийлсэн хувь тооцоолно
                    <br />
                  ...
                  <p className="text-xs text-amber-500 mt-3">
                    8 кредит зарцуулна. Pro/Premium багцад.
                  </p>
                </CardContent>
              </Card>
              ...
              <div className="flex gap-2 mt-4">
                <Button
                  ...
                  disabled={
                    isLoading || isSuperLoading || (!imageFile && !imageUrl)
                  }
                  variant="outline"
                  className="flex-1"
                >
            ...
            <CardContent className="space-y-6">
                  ...
                  <div className="flex flex-col md:flex-row items-center justify-between gap-4">
                    ...
                    <div className="text-center">
                      ...
                      <p className="text-2xl font-bold text-cyan-400">
                        {superAnalysisResult.unified.consensusRatio} арга
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-6">
                    <div className="text-center p-3 bg-background/50 rounded-lg">
                      ...
                      <p className="text-xl font-bold">
                        {superAnalysisResult.unified.entryPrice.toFixed(2)}
                      </p>
                    </div>
                    <div className="text-center p-3 bg-red-500/10 rounded-lg">
                      <p className="text-xs text-red-400">Stop Loss</p>
                      <p className="text-xl font-bold text-red-400">
                        {superAnalysisResult.unified.stopLoss.toFixed(2)}
                      </p>
                    </div>
                    <div className="text-center p-3 bg-green-500/10 rounded-lg">
                      <p className="text-xs text-green-400">TP1</p>
                      <p className="text-xl font-bold text-green-400">
                        {superAnalysisResult.unified.takeProfit1.toFixed(2)}
                      </p>
                    </div>
                    <div className="text-center p-3 bg-green-500/10 rounded-lg">
                      <p className="text-xs text-green-400">TP2</p>
                      <p className="text-xl font-bold text-green-400">
                        {superAnalysisResult.unified.takeProfit2.toFixed(2)}
                      </p>
                    </div>
                  </div>
                </CardContent>
              ...
              <div>
                <h3 className="text-lg font-semibold mb-4">
                  Арга тус бүрийн үр дүн:
                </h3>
                <div className="space-y-3">
                  {[
                    {
                      name: 'Traditional',
                      data: superAnalysisResult.traditional,
                    },
                      ...
                      <CardContent className="p-4">
                        <div className="flex items-center justify-between">
                          <div className="flex items-center gap-3">
                            ...
                            <Badge
                              variant={
                                method.data.signal === 'BUY'
                                  ? 'default'
                                  : method.data.signal === 'SELL'
                                    ? 'destructive'
                                    : 'secondary'
                              }
                              className={cn(
                            ...
                            {method.data.signal ===
                              superAnalysisResult.unified.direction && (
              ...
              <div>
                ...
                <div className="p-4 bg-muted/50 rounded-lg">
                  <p className="text-sm">
                    {superAnalysisResult.unified.summary}
                  </p>
                </div>
              </div>
            </CardContent>
