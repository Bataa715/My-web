      ...
      >
        ...
        <div className="text-center pt-8 flex flex-col items-center justify-center gap-6">
          <motion.div
            ...
            className="relative"
          >
            <div className="absolute inset-0 bg-linear-to-r from-rose-500/30 via-pink-500/30 to-fuchsia-500/30 blur-3xl rounded-full scale-150" />
            <div className="relative p-5 rounded-2xl bg-linear-to-br from-rose-500/20 to-pink-500/20 backdrop-blur-xs border border-rose-500/20">
          ...
          <div className="flex items-center gap-4">
            <motion.h1
              className="text-4xl md:text-5xl font-bold font-headline bg-linear-to-r from-rose-400 via-pink-400 to-fuchsia-400 bg-clip-text text-transparent"
              ...
              <div className="flex items-center gap-2">
                ...
                >
                  <Button
                    variant="default"
                    size="sm"
                    className="bg-linear-to-r from-rose-500 to-pink-500 hover:from-rose-600 hover:to-pink-600 text-white rounded-xl gap-2"
                  >
